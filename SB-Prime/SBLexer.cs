...
namespace SB_Prime
{
    ...
    public class SBLexer : IDisposable
    {
        ...
        private void InitSyntaxColoring()
        {
            ...
            styles.Add(new SBStyle(STYLE_OBJECT, new Regex("^[" + MainWindow.exRegex + "A-Za-z_]+[\\.][" + MainWindow.exRegex + "A-Za-z_]+")));
            styles.Add(new SBStyle(STYLE_SUBROUTINE, new Regex("^[" + MainWindow.exRegex + "A-Za-z_]+[ ]*[(]")));
            styles.Add(new SBStyle(STYLE_LABEL, new Regex("^[" + MainWindow.exRegex + "A-Za-z_]+[ ]*[:]")));
